...
export function isRequired(value: string, _values = {}) {
...
export function isSignature(value: string, _values = {}) {
...
export function isEmail(value: string, _values = {}) {
	if (!value) return [ 'This field is required' ];
	if (value && !validator.isEmail(value)) return [ 'Email address is invalid' ];
}

export function isNumeric(value: string, _values = {}) {
	if (!value) return [ 'This field is required' ];
	if (value && !validator.isNumeric(value)) return [ 'Please Input a Number' ];
}

export function isMobile(value: string, _values = {}) {
	if (!value) return [ 'This field is required' ];
