...
import { InputField, PageHeader, TransactionList, RadioField, TextAreaField, SelectField, AutoCompleteField, SignatureField, CheckField, FormikForm, RadioButtonField, PasswordField, InvoiceList, SummaryList, SummaryRow, Item, ItemList, CustomerSearchField, TransactionSearchField } from '/imports/ui/components';
    ...
    return (<>
        ...
        setTimeout(() => {
            ...
            actions.setSubmitting(false);
                ...
                {(props) => (<FormikForm isLoading={props.isSubmitting} analyticName="Signup Form" formProps={props} buttonName="Signup">
                        ...
                        <TransactionList customerStatus="10 days to overdue" customerName="Bukola Saraki" amount="GHC233" paymentStatus="PAID" overdueAmount="GHC346" overdueStatus="OVERDUE" cardLink="/signup" iconName="chevron-right" iconSize="24px" analyticName="Click Transaction item"/>
                        <InvoiceList customerName="Joe Bimond" amount="GHC 200" date=" 12 Jan 2020" link="path.workspace.createTransaction"/>

                        <SummaryRow>
                            <SummaryList name="Evans Dabo" phone="020 747 475" email="me@gmail.com" location="22 Aluguntugui East legon Accra" iconName="view" iconSize="15px"/>
                        </SummaryRow>

                        <Item>
                            <ItemList analyticName="Click Invoice Item" customerItem="LG Mini Home" customerName="Bukola Saraki" amount="GHC346"/>
                        </Item>
