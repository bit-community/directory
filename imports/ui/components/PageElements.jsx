...
const LogoHeader = () => {
    ...
    return (<BreakLayout marginT="-10px">
      <Headroom wrapperStyle={{ marginBottom: '2.5rem' }} style={{ zIndex: 9999999999999, borderBottom: '1px solid #ddd' }}>
        <Navbar>
...
export const PageHeader = (props) => {
    ...
    return (<React.Fragment>
      {useHeader ? (<LogoHeader />) : (<Box my="4" bg="inherit">
...
export const DesktopLayout = (props) => {
    return (<Stack maxWidth="800px" margin="auto" px={[3, 4, 6, 8]} {...props}>
      {props.children}
    </Stack>);
};
